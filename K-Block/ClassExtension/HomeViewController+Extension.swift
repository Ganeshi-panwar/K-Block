...
extension HomeViewController{
    ...
    //    func addDashBorder(To button: UIButton , withRadius radius:CGFloat , andBorderWidth borderWidth: CGFloat){
    //
    ...
    //            animation.toValue = dashBorder.lineDashPattern?.reduce(0) { $0 + $1.intValue } // Sum of the pattern
    //        animation.duration = 0.1 // Adjust the duration as needed
    //            animation.repeatCount = .infinity // Repeat indefinitely
    //            dashBorder.add(animation, forKey: "lineDashPhaseAnimation")
